...
class MapperTest extends TestCase
{
    ...
    public function testArray()
    {
        $data = [
            ...
            'generic2' => [['dateStart' => new \DateTime('-1 day'), 'dateEnd' => new \DateTime()]],
            'array1' => [1, 2, 3],
            'array2' => [4, 5, 6],
            'scalar1' => 8,
            'scalar2' => true,
        ...
        $this->assertEquals($data['generic2'][0]['dateStart'], $object->getGeneric2()[0]->getDateStart());
        $this->assertEquals($data['generic2'][0]['dateEnd'], $object->getGeneric2()[0]->getDateEnd());
